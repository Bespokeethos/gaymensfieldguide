...
declare type AgentAction = "fix" | "fix-pr-comment";
...
declare type AssistantMessageEvent_2 = {
    ...
    message: ChatCompletionMessageParamsWithFunctionToolCalls & ReasoningMessageParam;
};
...
declare type ChatCompletionMessageParamsWithFunctionToolCalls = Omit<ChatCompletionAssistantMessageParam, "tool_calls"> & {
...
declare type CopilotChatCompletionChunkDelta = ChatCompletionChunk.Choice.Delta & ReasoningMessageParam;
...
export declare const INTEGRATION_ID = "copilot-developer-cli";
 ...
 */
export declare class LocalSession extends Session<SessionMetadata> {
    private callback;
 ...
 */
declare class LocalSessionManager implements SessionManager {
     ...
     */
    createSession(options?: SessionOptions): Promise<LocalSession>;
    /**
...
declare type PostToolExecutionContext = {
     ...
     */
    readonly toolCall: ChatCompletionMessageFunctionToolCall;
    /**
...
declare type PreToolsExecutionContext = {
     ...
     */
    readonly toolCalls: ChatCompletionMessageFunctionToolCall[];
    /**
     * Information about the model being called.
     */
    readonly modelInfo: CompletionWithToolsModel;
...
export declare const SessionEventSchema: z.ZodDiscriminatedUnion<"type", [z.ZodObject<{
    ...
    data: z.ZodObject<{
        legacySession: z.ZodObject<{
            ...
            selectedModel: z.ZodOptional<z.ZodEnum<["claude-sonnet-4.5", "claude-sonnet-4", "claude-haiku-4.5", "gpt-5", "gpt-5.1", "gpt-5.1-codex-mini", "gpt-5.1-codex", "gemini-3-pro-preview"]>>;
        }, "strip", z.ZodTypeAny, {
            sessionId: string;
            startTime: Date;
            chatMessages: ({
            ...
            selectedModel?: "gpt-5" | "claude-sonnet-4" | "claude-sonnet-4.5" | "gpt-5.1" | "gpt-5.1-codex" | "gpt-5.1-codex-mini" | "gemini-3-pro-preview" | "claude-haiku-4.5" | undefined;
        }, {
            sessionId: string;
            startTime: Date;
            chatMessages: ({
...
declare const SUPPORTED_MODELS: readonly ["claude-sonnet-4.5", "claude-sonnet-4", "claude-haiku-4.5", "gpt-5", "gpt-5.1", "gpt-5.1-codex-mini", "gpt-5.1-codex", "gemini-3-pro-preview"];
