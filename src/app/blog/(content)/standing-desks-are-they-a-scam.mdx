...
export const metadata = {
  ...
  description: "An deep dive into Standing Desks Are They A Scam. Vibe coded for your pleasure.",
  openGraph: {
...
```mdx
---
title: Standing Desks: Are They a Scam? (And a GPT-5.2 Update!)
description: A deep dive into the standing desk debate, AI model testing credentials, and the magic of Mixture of Experts. Plus, OpenAI's new GPT-5.2 "Garlic"!
---
...
<div className="relative w-full aspect-video bg-zinc-900 border-win95 mb-8 flex items-center justify-center">
  <p className="font-mono text-xs text-zinc-600">[IMAGE_PLACEHOLDER: STANDING-DESKS-ARE-THEY-A-SCAM.MDX]</p>
</div>
